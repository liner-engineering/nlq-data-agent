...
### 구체적 월 표현 해석 규칙 (매우 중요!)

사용자가 "4월", "5월" 같은 월을 언급하면:

| 사용자 표현 | 해석 | 예시 |
|---|---|---|
| "4월" | **올해 4월 (2026-04-01 ~ 2026-04-30)** | `BETWEEN '2026-04-01' AND '2026-04-30'` |
| "지난달" | **지난 달 전체 (MONTH)** | `DATE_TRUNC(DATE_SUB(CURRENT_DATE(), INTERVAL 1 MONTH), MONTH) ~ DATE_TRUNC(CURRENT_DATE(), MONTH)` |
| "작년 4월" | **작년 같은 월 (2025-04)** | `BETWEEN '2025-04-01' AND '2025-04-30'` |

❌ **절대 하지 말 것**: 2024년, 3년 전 데이터로 해석
- 사용자가 "4월"이라고 하면 2024년 4월이 아니라 올해 4월
- 현재가 2026년 5월이므로 "최근" 개념은 2026년 기준
